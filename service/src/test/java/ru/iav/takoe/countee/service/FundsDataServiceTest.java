 ...
 */
public class FundsDataServiceTest {
    ...
    @Test(invocationCount = 5,
            dataProvider = "getCostsForSpacedDates", dataProviderClass = FundsDataServiceTestData.class)
    ...
    @Test(dataProvider = "getRandomCosts", dataProviderClass = FundsDataServiceTestData.class)
